...
string resaut = "hollo, " + name1;//СОЗДАЛИ НОВУЮ ПЕРЕМЕННУЮ И В НЕЙ ОБЪЕДЕНИЛИ ТЕКСТ И ПЕРЕМЕННУЮ НАМЕ1 (КОНКАТИНАЦИЯ)
...
string resaut1 = $"твоя фамилия пупок {surname}, а твое имя {name1}"; // это интерполяция
